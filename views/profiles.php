...
<body class="bg">
    ...
    <form method="post" class="container" style="color: var(--biruBG1); font-weight: var(--fwbold);">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="fullname" readonly class="form-control-plaintext input-line" value="<?= $getAccount['data']['fullname'] ?>">
        </div>

        <div class="mb-3">
            <label class="form-label">Nomor Induk Keluarga</label>
            <input type="text" name="nik" readonly class="form-control-plaintext input-line" value="<?= $getAccount['data']['nik'] ?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Alamat</label>
            <input type="text" name="address" readonly class="form-control-plaintext input-line" value="<?= $getAccount['data']['address'] ?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Nomor HP</label>
            <input type="text" name="whatsapp" readonly class="form-control-plaintext input-line" value="<?= $getAccount['data']['whatsapp'] ?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Jenis Kelamin</label>
            <input type="text" name="gender" readonly class="form-control-plaintext input-line" value="<?= $getAccount['data']['gender'] ?>">
        </div>
